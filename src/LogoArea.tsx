...
export const LogoArea = ({animateLogo}: LogoArea) => {
  return (
    <>
    <div className={`bg-[url('/stag.png')] bg-contain bg-center w-full h-screen bg-no-repeat flex items-center justify-center text-center mix-blend-multiply relative z-10 ${animateLogo ? 'animate-[logoarea_4s_ease-in-out_forwards]' : ''}`}>
        <div className="backdrop-blur-sm py-4 px-4 text-lg md:text-2xl text-center flex items-center justify-center flex-col absolute z-20 bottom-0 w-full">
