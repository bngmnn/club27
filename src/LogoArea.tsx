export const LogoArea = () => {
  return (
    <>
    <div className="bg-[url('src/assets/stag.png')] bg-contain bg-center w-full h-96 bg-no-repeat flex items-center justify-center text-center mix-blend-multiply relative z-10 ">
